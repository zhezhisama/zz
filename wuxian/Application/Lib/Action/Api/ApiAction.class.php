...
class ApiAction extends Action {
...

	{
...

		{
			...
			$img->open($ticket)->thumb(240, 240)->save($ticket);
			...
			$img->open('./card.jpg')->water($ticket, array(196,611))->water($logo, array(290,713))->text($name,'./hei.ttf','18','#000000', array(130,566))->save($user_pic);
			...
			{
				$img->open('./card.jpg')->water($ticket, array(186,601))->text($name,'./hei.ttf','18','#000000', array(100,566))->save($user_pic);
...
//-----------自动发货
	...
	public function autofahuo($id) {
            /*更改为自动收货*/
			M ("Order")->where(array('orderid'=>$id))->save (array('order_status'=>2));	//自动设置为已发货状态		
