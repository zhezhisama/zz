...
<body class="sanckbg mode_webapp">
					...
					<ul>
						...
						<li>
									...
									<tr>
										<td style="height:70px;" >
											<div class="ui-input-text">
                                            	<span>充值:</span>
												<input id="price" name="price" placeholder="" value="<?php echo ($price); ?>" type="text" class="ui-input-text" readonly>
							...
							<div class="footReturn">
                              ...
                              <a id="txshowcard" class="submit" href="javascript:;"  onClick="callpay()">微信安全支付</a>
							</div>
	...
	<div class="footermenu"><!--./index.php?g=App&m=Index&a=index-->
		<ul>
			<li ><a href="/index.php?g=App&m=Index&a=member&etype=1"  class="active"> <img src="../Public/Static/images/21.png">
					<p>首  页</p>
			</a></li>
