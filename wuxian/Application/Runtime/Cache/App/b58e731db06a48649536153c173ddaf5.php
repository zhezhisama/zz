		...
		<section class="order">
			<form name="txinfoForm" id="txinfoForm" method="post" action="">
				<div class="contact-info" style="margin-top:0px; padding-top:0px;">
					<ul>
						<li class="title" style="color:red;font-size:14px">警告：如发现在本平台恶意刷积分者，账户封停，并追究法律责任！如有疑问，请点击页面底部客服！</li>
							...
							<table style="padding: 0; margin: 0; width: 100%;">
								<tbody>
									...
									<tr style="display:none;">
										...
										<td>
											<div class="ui-input-text">
												<input id="bank_name" name="bank_name" placeholder="" value="kai hu hang" type="text"
													class="ui-input-text">
											</div>
										</td>
									</tr>
									...
									<tr style="display:none;"> 
										<td width="80px"><label for="bank_num" class="ui-input-text">支付宝：</label></td>
										<td>
											<div class="ui-input-text">
												<input id="bank_num" name="bank_num" placeholder="请输入您的支付宝账户" value="zhifubao" type="text"
													class="ui-input-text">
											</div>
										</td>
									</tr>
									...
									<tr style="display:none;">
										<td width="80px"><label for="name" class="ui-input-text">姓&nbsp&nbsp&nbsp&nbsp名：</label></td>
										<td>
											<div class="ui-input-text">
												<input id="name" name="name" placeholder="请输入您的姓名" value="" type="text"
													class="ui-input-text">
											</div>
										</td>
									</tr>
									...
									<tr style="display:none;">
										<td width="80px"><label for="bank_name" class="ui-input-text">电&nbsp&nbsp&nbsp&nbsp话：</label></td>
										<td>
											<div class="ui-input-text">
												<input id="tel" name="tel" placeholder="请输入您的电话" value="" type="tel"
													class="ui-input-text">
                                                 <input id="openid" name="openid" value="<?php echo ($openid); ?>" type="hidden" />
											</div>
										</td>
									</tr>
									<tr>
                                    	<td colspan="2" style="font-size:14px; color:#f00;">注： 单次兑换大于1小于200。(兑换时间8:00-24:00)</td>
                                    </tr>
								</tbody>
							</table>

							<div class="footReturn">
								<a id="txshowcard" class="submit" href="javascript:submitTxOrder();">提&nbsp;&nbsp;&nbsp;&nbsp;交</a>
							</div>
		...
		<ul class="round">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="cpbiaoge">
					...
					<?php if(is_array($tx_record)): $i = 0; $__LIST__ = $tx_record;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tx_record): $mod = ($i % 2 );++$i;?><tr>
						...
						<!--<td class="cc"><?php echo ($tx_record["bank_name"]); ?></td>-->
