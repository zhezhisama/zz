...
<div id="member-container" style="display: block;">
		...
		<div class="div_header" style="display:none;">
				...
				<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$result): $mod = ($i % 2 );++$i;?><li>
						<div style="">
							...
							<span class="header_right" style="margin-top:5px;">
								...
								<div><span>会员：<?php if($result["member"] == 1): ?>是<?php else: ?>否<!--a style='color:red' href='./index.php?g=App&m=Index&a=index'>点击链接成为会员</a--><?php endif; ?></span></div>
								<div><span>关注时间：<?php echo date('Y-m-d',$wx_info['subscribe_time']); ?></span>&nbsp;&nbsp;<span>会员ID：<?php echo ($result["id"]); ?>  </span></div>
							</span>
						</div>
...
<div class="cardexplain">
	<ul class="round" style="margin-left:0;margin-right:0;">
		...
		<li class="nob">
			<table>
				<tr><td><img height='80' src='Public/Uploads/<?php echo ($goodsdata["image"]); ?>'></td>
					<td>
                    <table>
						<tr><td>产品名称：<?php echo ($cart_name); ?><td></tr>
						<tr><td>产品单价：￥<?php echo ($cart_price); ?> * <?php echo ($cart_num); ?><td></tr>
                        <tr><td><div style='text-align:center;color:#ee0400;'>合计金额：<?php echo ($price); ?>元</div><td></tr>
					</table>
                    </td>
				</tr>
			</table>
...
<a style="color:red; font-size:14px;display:block;text-align:center;">注：支付成功后，切记一定要等待返回界面!</a>
<a style="color:red; font-size:14px;display:block;text-align:center;">购买成功后微信号自动登录</a>

	<div class="footReturn"style="text-align:center">
		<!--<input type="button" onClick="callpay()" style="margin:0 auto 20px auto;width:100%"  class="submit" value="微信支付"/>-->
 		  <a class="submit" href="javascript:;"  onClick="callpay()">微信安全支付</a>
	</div>

	<div class="footReturn" style="text-align:center; display:none;">
	

<input type="button" id="J_weixin" style="margin:0 auto 20px auto;width:100%" onClick="callpay()" class="submit" value="支付宝支付"/>

		
	</div>
</div>
<div id="weixin-tip"><p><img src="../Public/Static/images/<?php echo ($tbtspic); ?>" alt="使用浏览器打开"/><span id="close" title="关闭" class="close">×</span></p></div>
	...
	<ul class="round">
		...
		<li class="nob">
			<table width="100%"border="0"cellspacing="0"cellpadding="0"class="kuang">
				<tr><th style="color:red">支付失败</th><td><td></tr>
			</table>
		</li>
	</ul>
	<div class="footReturn"style="text-align:center">
