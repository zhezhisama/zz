...
<title style="text-align:center ;">超级无限人脉</title>
<meta name="viewport"
...
<body class="sanckbg mode_webapp">
	<div id="member-container" style="display: block;">
		...
		<div class="div_header">
            ...
            <div style="height:10px;"></div>
                ...
                <span style=" color:#fff !important; font-size:14px;">会员ID号：<?php echo ($users["id"]); ?></span></div>
		...
		<div style=" position: relative; height: 0px; width: 100%; font-size: 0px;">
			<div id="ttp" style="width: 50%; position: absolute; height: 120px; right: 0px;top: 80px; display: none; background: #673653; z-index: 999;">
				<div style="height: 40px; width: 100%; text-align: center; line-height: 40px;"><a  style="color: #fff; font-size: 14px;" href="/index.php?g=App&m=Index&a=cz&etype=2"> 积分充值</a></div>
                <div style="height: 40px; width: 100%; text-align: center; line-height: 40px;"><a style="color: #fff; font-size: 14px;" href="/index.php?g=App&m=Index&a=tx&etype=2" > 积分提现</a></div>
                <div style="height: 40px; width: 100%; text-align: center; line-height: 40px; "><a style="color: #fff; font-size: 14px;" href="/index.php?g=App&m=Index&a=jifen_info&type=1&id=<?php echo ($users["id"]); ?>" > 积分详情</a></div>
		...
		<ul class="function_ul">
            ...
            <li class="cc3">
            	<a href="/index.php?g=App&m=Index&a=yunorder">微商云订单</a>
            </li>
            <li class="cc4 fans">
            	超级人脉
            </li>
            <li class="cc5">
            	<a href="/index.php?g=App&m=Index&a=orderslist">我的订单</a>
            </li>
            <li class="cc6">
            	<a href="/index.php?g=App&m=Index&a=member&etype=3">推广二维码</a>
            </li>
            <li class="cc7">
            	<a href="<?php echo ($tool_url); ?>">会员福利</a>
            </li>
            <li class="cc8">
            	<a href="<?php echo ($fuli_url); ?>">工具大全</a>
            </li>
        </ul>
	...
	<div id="ticket-container" <?php if($etype == 3): ?>style="display: block !important; padding-bottom:55px;"<?php endif; ?> >
