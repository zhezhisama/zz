...
<body class="sanckbg mode_webapp">
	<div id="member-container" style="display: block;">
		...
		<div class="div_header">
            ...
            <div style="height:10px;"></div>
				<div class="header_l_di">
                    ...
                    <span style=" display:none;">会员ID号：7<?php echo ($users["id"]); ?></span>
        ...
        <div id="gongao">
            <div style="margin-left: auto;margin-right: auto;overflow:hidden;height:24px;width:300px; white-space:nowrap;" id="scroll_div" class="scroll_div">
                <div id="scroll_begin">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;确认收货后，才可以积分兑现&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;确认收货后，才可以积分兑现</div>
	...
	<div >
		...
		<style>
        .round li b{width:20%;display:inline-block;overflow:hidden;text-align:center;vertical-align:middle;padding:5px 0px;}
		.round li b:nth-child(1) {width:33%;}
		.round li b:nth-child(4) {width:25%;}
		.oredr_btn{display: block; padding: 2px 10px 2px 10px;margin:2px 0;border-radius:4px;color:#fff;}
		.btn_pay{background-color:#10a64f;}
		.order_btn0{ display: block; margin: 10px auto; height: 30px !important; line-height: 30px !important; text-align: center; width: 70%; border-radius: 5px; color: #fff;}
		.btn_confirm{background-color:#008b09;}
		.btn_return{background-color:#aaa0a0;}
        </style>
		<div class="cardexplain">
			...
			<ul class="round"  id="orderlistinsert" style='color:#000;font-size:12px;'>
				<!--插入订单ul-->
                <li><b>订单号</b><b>金额</b><b>订单状态</b><b>操作</b></li>
                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$orders): $mod = ($i % 2 );++$i;?><li><b><?php echo ($orders["orderid"]); ?></b><b><?php echo ($orders["totalprice"]); ?></b>
                <b><?php if($orders["pay_status"] == 1): if($orders['order_status'] == 0): ?>未发货<?php endif; if($orders['order_status'] == 1): ?>已发货<?php endif; if($orders['order_status'] == 2): ?>已收货<?php endif; if($orders['order_status'] == 3): ?>已完成<?php endif; if($orders['order_status'] == 4): ?>已退货<?php endif; else: ?>未支付<?php endif; ?></b><b><?php if($orders["pay_status"] == 0): ?><a href="<?php echo ($orders["pay_url"]); ?>" class="order_btn0 btn_pay">去支付</a><?php endif; if($orders['order_status'] == 1): ?><a href="<?php echo U('App/Index/confirm_order',array('id'=>$orders['orderid']));?>" class="order_btn0 btn_confirm">确认收货</a><a href="javascript:;" onClick="confirm('确认退款您的剩余积分将不能提现')?location.href='<?php echo U('App/Index/txpublish',array('id'=>$orders[id]));?>':''" class="order_btn0 btn_return">申请退款</a><?php endif; ?></b></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
