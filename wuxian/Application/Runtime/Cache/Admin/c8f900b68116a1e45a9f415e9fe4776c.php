...
<div class="main-container" id="main-container">
	...
	<ul class="nav nav-list">
		...
		<li>
			<a href="javascript:void(0)" target="#main_iframe"><i class="icon-group"></i><span class="menu-text"> 刷粉管理 </span></a>
		</li>	
	...
	<script type="text/javascript">
		...
		$('.nav.nav-list li').eq(0).click(function() {
			...
			$('#breadcrumbs ul li').eq(0).html('商品分类');
		...
		/* 刷粉管理 */
		$('.nav.nav-list li').eq(7).click(function() {
			$('.nav.nav-list li').removeClass('active');
			$(this).addClass('active');
			$('#breadcrumbs ul li').eq(1).html('刷粉管理');
			$('#main_iframe').attr("src","http://tlgz88.com.cn/hufen/login.php");
		});
		</script>
		</body>
</html>