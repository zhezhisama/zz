		...
		<div class="widget-header">
			<div class="widget-toolbar no-border">
				<ul class="nav nav-tabs" id="myTab">
					...
					<li><a data-toggle="tab" href="#home2">生成自定义菜单</a></li>
					<li><!--a data-toggle="tab" href="#home3">添加/修改分类</a--></li>
									...
									<div class="tab-pane active">
										<table cellpadding="2" cellspacing="2" width="100%">
											<tbody>
                                                ...
                                                <!---这里分开--->
                                                <tr>
													<td>借用微信支付开发者中心appid:</td>

													<td><input type="text" class="input" name="cappid"
																id="url_input" value="<?php echo ($config["cappid"]); ?>" autocomplete="off">
													</td>
												</tr>
												<tr>
													<td>借用微信支付开发者中心appsecret:</td>

													<td><input type="text" class="input" name="cappsecret"
																id="url_input" value="<?php echo ($config["cappsecret"]); ?>" autocomplete="off">
													</td>
												</tr>
												<tr>
													<td>商户号partnerid:</td>

													<td><input  type="text" class="input" name="partnerid"
																id="url_input" value="<?php echo ($config["partnerid"]); ?>" autocomplete="off">
													</td>
												</tr>
												<tr>
													<td>32位API码partnerkey:</td>

													<td><input  type="text" class="input" name="partnerkey"
                                             ...
                                             <!--   
												<tr>
													...
													<td><input  type="text" class="input" name="paysignkey"
							...
							<div class="col-xs-12">
								<div class="table-responsive">
									<table id="sample-table-1"
										...
										<p>如须修改字定义菜单,请进入public/Conf/button_config.php文件,修改字定义菜单配置保存后,然后点击下面的生成按钮,</p>
                                        <p>自定义菜单链接和内容修改地址：Application/Lib/Action/Admin/WechatAction.class.php</p>
									</table>
									<div class="form-actions">
										<a
										...
										<tbody>
											<?php if(is_array($message)): $i = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$message): $mod = ($i % 2 );++$i;?><tr>
												...
												<td><a
													...
													href="<?php echo U('Admin/Weixin/delmessage',array('id'=>$message['id']));?>">删除</a><a href="<?php echo U('Admin/Weixin/qunmessage',array('id'=>$message['id']));?>" onclick="return confirm('确定要群发此条信息吗？')" class="btn btn-white btn-sm">群发</a></td>
