								...
								<div class="table-responsive">
									<table id="sample-table-1"
										...
										<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$result): $mod = ($i % 2 );++$i;?><tr>
												...
												<td><?php if($result['status'] == 1): else: ?><a href="<?php echo U('Admin/Tx/payComplete',array('id'=>$result['id']));?>" class="btn btn-white btn-sm">已支付</a><?php endif; ?><a class="btn btn-white btn-sm" href="<?php echo U('Admin/Tx/del',array('id'=>$result['id']));?>">删除</a></td>
