			...
			<div class="widget-main padding-12 no-padding-left no-padding-right">
				<div class="tab-content padding-4">
					...
					<div id="home5" class="tab-pane in">						
						...
						<div class="form-group">										
						<label class="col-sm-8 control-label no-padding-right" > 以下是微信红包参数配置（详细配置请联系QQ:53867784）</label>																	
												
						</div>
                        <div class="form-group">										
						<label class="col-sm-3 control-label no-padding-right" for="form-field-5">公众号appid： </label>										
						<div class="col-sm-9">											
						<input type="text" id="form-field-5" value="<?php echo ($tixianinfo["appid"]); ?>" name="appid" class="col-xs-10 col-sm-6">										
						</div>									
						</div>
                        <div class="form-group">										
						<label class="col-sm-3 control-label no-padding-right" for="form-field-6">商户号mchid： </label>										
						<div class="col-sm-9">											
						<input type="text" id="form-field-6" value="<?php echo ($tixianinfo["mchid"]); ?>" name="mchid" class="col-xs-10 col-sm-6">										
						</div>									
						</div>
                         <div class="form-group">										
						<label class="col-sm-3 control-label no-padding-right" for="form-field-7">支付key： </label>										
						<div class="col-sm-9">											
						<input type="text" id="form-field-7" value="<?php echo ($tixianinfo["key"]); ?>" name="key" class="col-xs-10 col-sm-6">										
						</div>									
						</div>
                        <div class="form-group">										
						<label class="col-sm-3 control-label no-padding-right" for="form-field-8">红包发送者名称： </label>										
						<div class="col-sm-9">											
						<input type="text" id="form-field-8" value="<?php echo ($tixianinfo["send_name"]); ?>" name="send_name" class="col-xs-10 col-sm-6">										
						</div>									
						</div>
                        <div class="form-group">										
						<label class="col-sm-3 control-label no-padding-right" for="form-field-9">红包名称： </label>										
						<div class="col-sm-9">											
						<input type="text" id="form-field-9" value="<?php echo ($tixianinfo["act_name"]); ?>" name="act_name" class="col-xs-10 col-sm-6">										
						</div>									
						</div>
						<div class="clearfix form-actions">										
						<div class="col-md-offset-3 col-md-9">											
