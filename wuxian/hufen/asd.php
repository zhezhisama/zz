...
if($_POST[wxtitle]){
	...
	if($gai==1){
		...
		$sql="INSERT INTO weixin (id,`name`,photoimg,codeimg,addr,prov,city,miaoshu,cdate,uid,wxid,shuaxin)" .
			"VALUES(
				0,
				'{$wxtitle}',
				'{$_POST["wximg"]}',
...
<?php if($xiu==1){?>
	<div class="body">
			...
			<li class="">
				...
				?>	
					<span>
						...
						<span class='delimg1' rel='<?=$code_data[$xu][photoimg]; ?>'>更改</span>
					</span>
				<?
					}
				?>
			...
			<li class="">
				...
				?>	
					<span>
						...
						<span class='delimg' rel='<?=$code_data[$xu][codeimg]; ?>'>更改</span>
					</span>
				<?
					}
				?>
		...
		<form action="asd.php" method="post" id="codeform" enctype="multipart/form-data">
			<ul class="upinfo">
				<li class=""><b>昵称：</b><a style="color:red;">如提“添加信息失败”请删除昵称中的表情符号</a><input type="text" value="<?=$code_data[$xu][name]; ?>" name="wxtitle" placeholder="填写我的昵称"/></li>
...
<?php }else if($xiu==2){?>
	<div class="body">
		...
		<form action="asd.php" method="post" id="codeform" enctype="multipart/form-data">
			<ul class="upinfo">
				<li class=""><b>昵称：</b><a style="color:red;">如提“添加信息失败”请删除昵称中的表情符号</a><input type="text" value="<?=$code_data[0][name]; ?>" name="wxtitle" placeholder="填写我的昵称"/></li>
				<!--<li class=""><b>微信号：</b><input type="text" value="<?=$code_data[wxid]; ?>" name="wxid" placeholder="填写我的微信号"/></li>-->
				<!--<li class="" style="width:30%;float:left;"><b>性别：</b>
					<div style="margin-top:10px;font-size:16px;">
						<select class="sex" name="sex" style="font-size:14px;">
