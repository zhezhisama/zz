function fullAvatarEditor() {
	...
	var file			= "/wxdh/Apps/Tpl/weixinqun/Public/fullAvatarEditor/fullAvatarEditor.swf";		//flash文件的路
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= '__ROOT__//wxdh/Apps/Tpl/weixinqun/Public/fullAvatarEditor/expressInstall.swf';			//expressInstall.swf的路径
