...
<Nonce><![CDATA[%s]]></Nonce>
	...
	public function createNativePackageXml($appid,$mch_id,$nonce_str,$body,$out_trade_no,$total_fee,$notify_url,$spbill_create_ip){
	
	    $arrdata = array("appid" => $appid,"mch_id" => $mch_id, "nonce_str" => $nonce_str, "body" => $body, "out_trade_no" => $out_trade_no, "total_fee" => $total_fee, "spbill_create_ip" => $spbill_create_ip, "notify_url" => $notify_url, 'trade_type'=>'NATIVE');
